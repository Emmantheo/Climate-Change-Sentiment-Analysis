...
# climate_sentiment_analysis documentation build
...
from climate_sentiment_analysis import __version__ as release

# -- Project information -----------------------------------------------------

project = "climate_sentiment_analysis"
author = "Kedro"
...
htmlhelp_basename = "climate_sentiment_analysisdoc"
...
latex_documents = [
    (
        master_doc,
        "climate_sentiment_analysis.tex",
        "climate_sentiment_analysis Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "climate_sentiment_analysis",
        "Project climate_sentiment_analysis codebase.",
        "Data-Science",
    )
]
